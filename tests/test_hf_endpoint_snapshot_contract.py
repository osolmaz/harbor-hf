...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("name",), 1, "endpoint.name must be a string"),
        (("model", "repository"), None, "model.repository must be a string"),
        (("model", "revision"), None, "model.revision must be a string"),
        (("model", "framework"), None, "model.framework must be a string"),
        (("model", "task"), None, "model.task must be a string"),
        (
            ("model", "image", "custom", "url"),
            None,
            "model.image.custom.url must be a string",
        ),
        (
            ("model", "image", "custom", "healthRoute"),
            None,
            "model.image.healthRoute must be a string",
        ),
        (("model", "args"), [1], "model.args must be an array of strings"),
        (("model", "secrets"), [], "model.secrets must be an object"),
        (
            ("compute", "accelerator"),
            None,
            "compute.accelerator must be a string",
        ),
        (
            ("compute", "instanceSize"),
            None,
            "compute.instanceSize must be a string",
        ),
        (
            ("compute", "instanceType"),
            None,
            "compute.instanceType must be a string",
        ),
        (
            ("compute", "scaling", "minReplica"),
            True,
            "scaling.minReplica must be an integer",
        ),
        (
            ("compute", "scaling", "maxReplica"),
            True,
            "scaling.maxReplica must be an integer",
        ),
        (
            ("compute", "scaling", "scaleToZeroTimeout"),
            True,
            "scaling.scaleToZeroTimeout must be an integer",
        ),
        (
            ("compute", "scaling", "measure"),
            {},
            "scaling.measure must contain exactly one metric",
        ),
        (
            ("compute", "scaling", "measure"),
            {"hardwareUsage": 1, "pendingRequests": 2},
            "scaling.measure must contain exactly one metric",
        ),
        (
            ("compute", "scaling", "measure"),
            {"unsupported": 1},
            "scaling.measure contains an unsupported metric",
        ),
        (
            ("compute", "scaling", "measure"),
            {"pendingRequests": "one"},
        ...
        (("provider", "vendor"), None, "provider.vendor must be a string"),
        (("provider", "region"), None, "provider.region must be a string"),
        (("accountId",), 1, "accountId must be a string"),
        (("route", "domain"), 1, "route.domain must be a string"),
        (("route", "path"), 1, "route.path must be a string"),
        (("tags",), [1], "endpoint.tags must be an array of strings"),
        (("status", "state"), 1, "status.state must be a string"),
        (
            ("status", "targetReplica"),
            True,
            "status.targetReplica must be an integer",
        ),
        (("status", "url"), 1, "status.url must be a string"),
    ],
)
